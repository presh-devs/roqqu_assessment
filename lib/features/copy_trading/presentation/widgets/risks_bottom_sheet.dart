...
class _RisksBottomSheetState extends State<RisksBottomSheet> {
  ...
  final List<Map<String, String>> _risks = [
    ...
    },
    {
      ...
      'description':
          'You are relying on another trader\'s decisions and strategies.',
    },
    {
    ...
    },
    {
      ...
      'description':
          'You may have limited control and understanding of trades being executed.',
    },
    {
      'title': 'Emotional decisions',
      'description':
          'Traders may make emotional decisions that impact your investment.',
    },
    {
      'title': 'Costs involved',
      'description':
          'Copy trading may involve fees and commissions that reduce returns.',
    },
    {
      'title': 'Diversify',
          ...
          children: [
            ...
            Padding(
              ...
              child: AppButton(
                ...
                onPressed: () => context.push('/enter-amount'),
              ),
            ),
          ],
        ),
